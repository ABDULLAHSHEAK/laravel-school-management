                        ...
                        <div class="Typeahead Typeahead--twitterUsers">
                            <div class="u-posRelative">
                                <input class="demo-input Typeahead-input form-control-plaintext w-100" type="text"
                                    placeholder="Search Here .." name="q" title="" autofocus>
                    ...
                    <ul class="nav-menus">
                        ...
                        <li class="onhover-dropdown">
                            ...
                            <ul class="notification-dropdown onhover-show-div">
                                ...
                                <li>
                                    <p>
                                        <i class="fa fa-circle me-2 font-primary"></i>Lorem ipsum dolor sit amet. <span
                                            class="pull-right">10 min.</span>
                                    </p>
                                </li>
                                <li>
                                    <p>
                                        <i class="fa fa-circle me-2 font-success"></i>Lorem ipsum dolor sit. <span class="pull-right">1 hr</span>
                                    </p>
                                </li>
                                <li>
                                    <p>
                                        <i class="fa fa-circle me-2 font-info"></i>Lorem ipsum dolor.<span
                                            class="pull-right">3 hr</span>
                                    </p>
                                </li>
                                <li>
                                    <p>
                                        <i class="fa fa-circle me-2 font-danger"></i>Lorem ipsum .<span
