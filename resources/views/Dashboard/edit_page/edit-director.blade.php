                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="mb-4 row align-items-center">
                                                                ...
                                                                <div class="col-md-9 col-lg-10">
                                                                    <input value="{{$directors->name}}" name="name" class="form-control @error('name')
                                                                    is-invalid
                                                                    @enderror" type="text">
                                                         ...
                                                         {{-- ------------ Directors title------------------  --}}
                                                            <div class="mb-4 row align-items-center">
                                                                ...
                                                                <div class="col-md-9 col-lg-10">
                                                                    <input value="{{$directors->title}}" name="title" class="form-control @error('title')
                                                                    is-invalid
                                                                    @enderror" type="text">
                                                                    <span class="text-danger">
                                                                        @error('title')
                                                            ...
                                                            <div class="mb-4 row align-items-center">
                                                                ...
                                                                <div class="col-md-9 col-lg-10">
                                                                    <input value="{{$directors->phone}}" name="phone" class="form-control @error('phone')
                                                                    is-invalid
                                                                    @enderror" type="text">
                                                                    <span class="text-danger">
                                                                        @error('phone')
                                                            ...
                                                            <div class="mb-4 row align-items-center">
                                                                ...
                                                                <div class="col-md-9 col-lg-10">
                                                                    <input value="{{$directors->date}}" name="date" class="form-control @error('date')is-invalid
                                                                    @enderror" type="date">
                                                                    <span class="text-danger">
                                                                        @error('date')
                                                                        {{$message}}
                                                            ...
                                                            <div class="mb-4 row align-items-center">
                                                                ...
                                                                <div class="col-md-9 col-lg-10">
                                                                    <input value="{{$directors->address}}" name="address" class="form-control @error('address')is-invalid
                                                                    @enderror" type="text">
                                                                    <span class="text-danger">
                                                                        @error('address')
                                                                        {{$message}}
                                                            ...
                                                            <div class="mb-4 row align-items-center">
                                                                ...
                                                                <div class="col-md-9 col-lg-10">
                                                                    <input value="{{$directors->email}}" name="email" class="form-control @error('email')
                                                                    is-invalid
                                                                    @enderror" type="email">
                                                                    <span class="text-danger">
                                                                        @error('email')
                                                            ...
                                                            <div class="mb-4 row align-items-center">
                                                                ...
                                                                <div class="col-md-9 col-lg-10">
                                                                    ...
                                                                    is-invalid
                                                                    @enderror" type="file">
                                                                    <img src="{{asset('image/director')}}/{{$directors->img}}" alt="director-img" width="80">
                                                                    <span class="text-danger">
                                                                        @error('img')
                                                                        {{$message}}
                                                                        @enderror
