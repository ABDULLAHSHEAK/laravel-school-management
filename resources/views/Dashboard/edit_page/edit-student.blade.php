                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="mb-4 row align-items-center">
                                                                ...
                                                                <div class="col-md-9 col-lg-10">
                                                                    <input value="{{$student->name}}" name="name" class="form-control @error('name')
                                                                    is-invalid
                                                         ...
                                                         {{-- ------------ Students father name------------------  --}}
                                                            <div class="mb-4 row align-items-center">
                                                                ...
                                                                <div class="col-md-9 col-lg-10">
                                                                    <input value="{{$student->fa_name}}" name="fa_name" class="form-control @error('fa_name')
                                                                    is-invalid
                                                            ...
                                                            <div class="mb-4 row align-items-center">
                                                                ...
                                                                <div class="col-md-9 col-lg-10">
                                                                    <input value="{{$student->ma_name}}" name="ma_name" class="form-control @error('ma_name')
                                                                    is-invalid
                                                            ...
                                                            <div class="mb-4 row align-items-center">
                                                                ...
                                                                <div class="col-md-9 col-lg-10">
                                                                    <input value="{{$student->student_phone}}" name="student_phone" class="form-control @error('student_phone')
                                                                    is-invalid
                                                            ...
                                                            <div class="mb-4 row align-items-center">
                                                                ...
                                                                <div class="col-md-9 col-lg-10">
                                                                    <input value="{{$student->parents_phone}}" name="parents_phone" class="form-control @error('parents_phone')
                                                                    is-invalid
                                                            ...
                                                            <div class="mb-4 row align-items-center">
                                                                ...
                                                                <div class="col-md-9 col-lg-10">
                                                                    <input value="{{$student->email}}" name="email" class="form-control @error('email')
                                                                    is-invalid
                                                            ...
                                                            <div class="mb-4 row align-items-center">
                                                                ...
                                                                <div class="col-md-9 col-lg-10">
                                                                    <input value="{{$student->birthdate}}" name="birthdate" class="form-control @error('birthdate')is-invalid
                                                                    @enderror" type="date">
                                                                    <span class="text-danger">
                                                                        @error('birthdate')
                                                                        {{$message}}
                                                            ...
                                                            <div class="mb-4 row align-items-center">
                                                                ...
                                                                <div class="col-md-9 col-lg-10">
                                                                    <input value="{{$student->roll}}" name="roll" class="form-control @error('roll')is-invalid
                                                            ...
                                                            <div class="mb-4 row align-items-center">
                                                                ...
                                                                <div class="col-md-9 col-lg-10">
                                                                    <input value="{{$student->reg}}" name="reg" class="form-control @error('reg')is-invalid
                                                            ...
                                                            <div class="mb-4 row align-items-center">
                                                                ...
                                                                <div class="col-md-9 col-lg-10">
                                                                    <input name="img" class="form-control mb-2 @error('img')
                                                                    is-invalid
                                                                    @enderror" type="file">
                                                                    <img src="{{asset('image/student')}}/{{$student->img}}" alt="student img" width="80">
                                                                    <span class="text-danger">
                                                                        @error('img')
                                                                        {{$message}}
                                                                        @enderror
