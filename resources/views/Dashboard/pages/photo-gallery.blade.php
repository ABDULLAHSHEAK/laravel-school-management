...
@section('content')
                                ...
                                <div>
                                    <div class="library-box">
                                        <label for="myCheckbox1">
                                            <div>
                                                <img src="{{ asset('image/photo-gallery') }}/{{ $photo->file }}"
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-end"
                                                    ...
                                                    <li><a class="dropdown-item d-flex align-items-center" href="{{ asset('image/photo-gallery') }}/{{ $photo->file }}"><i
                                                                class="ri-download-2-line me-2"></i>Download</a>
                                                    </li>
                                                    <li><a class="dropdown-item d-flex align-items-center" href="{{route('delete_photo_gallery',$photo->id)}}"><i
    ...
    @include('Dashboard.modal.photo-gallery')
@endsection
