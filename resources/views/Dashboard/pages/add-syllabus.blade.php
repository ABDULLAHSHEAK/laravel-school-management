                                ...
                                <div class="card-body">
                                    <div class="title-header option-title">
                                        ...
                                        <form class="d-inline-flex">
                                            <a href="{{route('all_syllabus')}}" class="align-items-center btn btn-theme d-flex">
                                                <i data-feather="plus"></i>All Syllabus
                                            </a>
                                        </form>
                                    </div>
                                                    ...
                                                    <form class="theme-form theme-form-2 mega-form" method="POST" enctype="multipart/form-data">
                                                        ...
                                                        <div class="row">
                                                            <div class="mb-4 row align-items-center">
                                                                <label
                                                                    class="form-label-title col-lg-2 col-md-3 mb-0">Syllabus Title</label>
                                                            ...
                                                            <div class="mb-4 row align-items-center">
                                                                <label
                                                                    class="col-lg-2 col-md-3 col-form-label form-label-title">Syllabus Descriptions</label>
                                                                <div class="col-md-9 col-lg-10">
